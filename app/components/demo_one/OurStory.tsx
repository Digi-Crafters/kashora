...
export default function OurStory() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E2C9AF] to-[#F7EFE4]" id="our-story">
      {/* Hero Section */}
      <section className="relative py-20 lg:py-32 overflow-hidden">
        ...
        {/* Floating Elements */}
        <motion.div 
          className="absolute top-10 left-5 w-20 h-20 bg-[#C8A55A]/20 rounded-full blur-xl"
          animate={{
            y: [0, -20, 0],
            scale: [1, 1.1, 1]
          }}
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            <motion.div
              ...
              className="h-1 bg-gradient-to-r from-[#12766D] to-[#C8A55A] mx-auto mb-8"
            />
            
            <h1 className={`${playfair.className} text-4xl md:text-6xl lg:text-7xl font-bold text-[#5A3A28] mb-6`}>
              Our Story
            </h1>
            
            <p className={`${inter.className} text-lg md:text-xl text-[#5A3A28]/80 leading-relaxed max-w-3xl mx-auto`}>
      ...
      <section className="py-20 bg-white/50 backdrop-blur-sm">
        <div className="container mx-auto px-4">
          <h2 className={`${playfair.className} text-3xl md:text-4xl font-bold text-center text-[#5A3A28] mb-16`}>
            Our Journey Through Time
          </h2>
          
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-4 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-[#12766D] to-[#C8A55A] transform -translate-x-1/2"></div>
            ...
            {timeline.map((item, index) => (
              ...
              >
                {/* Year Marker */}
                <div className="absolute left-4 md:left-1/2 w-8 h-8 bg-[#12766D] rounded-full border-4 border-white shadow-lg transform -translate-x-1/2 z-10"></div>
                
                {/* Content Card */}
                <div className={`flex-1 ${index % 2 === 0 ? 'md:pr-8 md:text-right' : 'md:pl-8'} ml-16 md:ml-0`}>
                  <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#E2C9AF] hover:shadow-xl transition-all duration-300">
                    <span className="text-[#C8A55A] font-bold text-lg">{item.year}</span>
                    <h3 className={`${playfair.className} text-xl font-semibold text-[#5A3A28] mt-2`}>
                      {item.title}
                    </h3>
                ...
                <div className="flex-1">
                  <motion.div
                    ...
                    className="relative rounded-2xl overflow-hidden shadow-lg bg-gradient-to-br from-[#12766D]/10 to-[#C8A55A]/10 p-4"
                  >
                    {/* Decorative Border */}
                    <div className="absolute inset-0 border-2 border-[#C8A55A]/30 rounded-2xl pointer-events-none"></div>
      ...
      {/* Values Section */}
      <section className="py-20 bg-gradient-to-br from-[#12766D]/5 to-[#C8A55A]/5">
        <div className="container mx-auto px-4">
          <h2 className={`${playfair.className} text-3xl md:text-4xl font-bold text-center text-[#5A3A28] mb-16`}>
            Our Values
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#E2C9AF] hover:shadow-xl transition-all duration-300 group-hover:transform group-hover:scale-105 h-full flex flex-col">
                  <div className="text-4xl mb-4">{value.icon}</div>
                  <h3 className={`${playfair.className} text-xl font-semibold text-[#5A3A28] mb-3`}>
                    {value.title}
                  </h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-6xl text-[#C8A55A] mb-4">&ldquo;</div>
            <blockquote className={`${playfair.className} text-2xl md:text-3xl text-[#5A3A28] italic mb-8`}>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-[#12766D] to-[#1C8076]">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className={`${inter.className} text-white/80 text-lg mb-8 max-w-2xl mx-auto`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="bg-[#C8A55A] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#D4B76E] transition-colors"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-[#12766D] transition-all"
              >
                Support Our Mission
              </motion.button>
            </div>
